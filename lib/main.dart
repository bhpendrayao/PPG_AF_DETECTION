...
//     connectionSubscription = device.connectionState.listen((BluetoothConnectionState state) async {
//       if (state == BluetoothConnectionState.connected) {
//         setState(() {
//           connectedDevice = device;
//         });
//
//         print("Connected to device! Navigating...");
//
...
//       home: Scaffold(
//         appBar: AppBar(title: Text('Bluetooth Scanner',style: TextStyle(color: Colors.white,fontWeight:FontWeight.w500),),
...
//
//     try {
//       var uri = Uri.parse("http://192.168.137.191:8080/upload_csv");
